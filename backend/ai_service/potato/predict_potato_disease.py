...
from potato_disease_classification import ClassificationCNN
...
CHECKPOINT_PATH = "ai_service/potato/cnn_potato_classification_best.pth.tar"
...
def predict_potato(model: ClassificationCNN, image_bytes: bytes) -> Tuple[str, float]:
    """Виконує передбачення хвороби картоплі, приймаючи байтову послідовність зображення."""

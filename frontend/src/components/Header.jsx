...
const Header = ({ navigate, isAuthenticated, onLogout }) => {
  return (
    // Фіксує хедер у верхньому правому куті, займаючи 100% ширини
    <header className="fixed top-0 left-0 right-0 p-4 text-green-400 text-lg z-50 bg-black/60 backdrop-blur-sm shadow-[0_0_15px_#00ff99]">

      {/* Змінено: justify-end на justify-between.
        Це відштовхує перший елемент (AgriScan) від останнього (nav)
        на максимальну відстань, вирівнюючи AgriScan зліва, а nav - справа.
      */}
      <div className="flex items-center **justify-between** space-x-6">

        {/* Логотип AgriScan - буде зліва */}
        <div
          className="font-bold cursor-pointer hover:text-green-300 transition"
          onClick={() => navigate("dashboard")}
        >
